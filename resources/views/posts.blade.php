<x-layout>
    ...
    {{-- <p class="text-xl">Ini adalah Blog</p> --}}
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    ...
                    <a href="{{ route('post-detail', ['post' => $post->slug]) }}" class="hover:underline">
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            {{ $post->title }}</h2>
                    </a>
                    <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($post->isi, 150) }}</p>
                    <div class="flex justify-between items-center">
                        {{-- <a href="{{ route('author.posts', ['user' => $post->author->username]) }}"> --}}
                        ...
                        <a href="{{ route('post-detail', ['post' => $post->slug]) }}"
            ...
            @empty
                <div>
                    ...
                    <a href="{{ route('all-posts') }}" class="block text-blue-600 hover:underline">&laquo; Back to
                        posts</a>
                </div>
            @endforelse
        </div>
